export const tableColorLabels = {
  ...
  canvas:"时间内容区", add:"添加事项空白条", grid:"网格线",
};
...
export const defaultTablePalettes:TablePalettes = {
  light:{project:"#E7EBF0",task:"#F0F3F7",month:"#E7EBF0",date:"#F0F3F7",canvas:"#FAFBFD",add:"#F0F3F7",grid:"#172033"},
  dark:{project:"#0B0E13",task:"#151A21",month:"#151A21",date:"#151A21",canvas:"#0E1116",add:"#11151C",grid:"#FFFFFF"},
};
...
export function migrateTablePalettes(value:unknown,version:unknown):TablePalettes {
  ...
  const previous={light:{project:"#d5deeb",task:"#e7edf5",month:"#d5deeb",date:"#e7edf5",canvas:"#ffffff",add:"#e2e7ee",grid:"#e5eaf2"},dark:{project:"#101827",task:"#1a2639",month:"#101827",date:"#1a2639",canvas:"#243248",add:"#1c293c",grid:"#35445c"}};
